...
class GenerateViewCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'manthra:view
    ...
    public function __construct()
    {
        ...
        $this->viewDirectoryPath = config('laravelmanthra.custom_template')
        ? config('laravelmanthra.path')
        : __DIR__ . '/../stubs/';

        if (config('laravelmanthra.view_columns_number')) {
            $this->defaultColumnsToShow = config('laravelmanthra.view_columns_number');
        }

        $this->delimiter = config('laravelmanthra.custom_delimiter') ? config('laravelmanthra.custom_delimiter') : ['%%', '%%'];
    }
    ...
    {
        $dynamicViewTemplate = config('laravelmanthra.dynamic_view_template') ? config('laravelmanthra.dynamic_view_template') : $this->defaultTemplating();
